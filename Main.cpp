...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(
                                    {CELL_SIZE * MAP_WIDTH * SCREEN_RESIZE, (FONT_HEIGHT + CELL_SIZE * MAP_HEIGHT) * SCREEN_RESIZE}), "Pac-Man",
                            sf::Style::Close);
    //Resizing the window.
    ...
    while (1 == window.isOpen()) {
        ...
        while (FRAME_DURATION <= lag) {
            ...
            while (const std::optional event = window.pollEvent()) {
                ...
                } else if (1 == sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Enter)) //Restarting the game.
                {
                    game_won = 0;
